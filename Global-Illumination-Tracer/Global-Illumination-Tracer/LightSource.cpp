...
LightSource::LightSource() {
	...
	intensity = 1;
	tris[0] = Triangle(Vertex(0, 0, 0), Vertex(0, 0, 0), Vertex(0, 0, 0), ColorDbl(255, 255, 255));
	tris[1] = Triangle(Vertex(0, 0, 0), Vertex(0, 0, 0), Vertex(0, 0, 0), ColorDbl(255, 255, 255));
...
LightSource::LightSource(Vertex v0, Vertex v1, Vertex v2, Vertex v3, double inIntensity)
{
	...
	tris[0] = Triangle(v0, v1, v2, ColorDbl(255, 255, 255));
	tris[1] = Triangle(v3, v2, v1, ColorDbl(255, 255, 255)); 
