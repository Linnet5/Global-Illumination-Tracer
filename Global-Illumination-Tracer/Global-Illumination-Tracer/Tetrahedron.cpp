...
Tetrahedron::Tetrahedron() {
	...
	sides[0] = Triangle(vertexList[1], vertexList[3], vertexList[2], ColorDbl(227, 242, 160), Material(0.18)); 
	sides[3] = Triangle(vertexList[1], vertexList[0], vertexList[2], ColorDbl(227, 242, 160), Material(0.18));  
	sides[1] = Triangle(vertexList[1], vertexList[0], vertexList[3], ColorDbl(227, 242, 160), Material(0.18));
	sides[2] = Triangle(vertexList[0], vertexList[3], vertexList[2], ColorDbl(227, 242, 160), Material(0.18));  
} 
