...
Tetrahedron::Tetrahedron() {
	...
	sides[1] = Triangle(vertexList[0], vertexList[2], vertexList[3], ColorDbl(227 * 0.8, 242 * 0.8, 160 * 0.8));
	sides[2] = Triangle(vertexList[0], vertexList[3], vertexList[1], ColorDbl(227 * 0.6, 242 * 0.6, 160 * 0.6));
